...
classes = (
    ...
    'Left heart ventre in cardiac MRI',
...
launcher = 'none'
load_from = '/path/to/checkpoints/dino_ayq.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/path/to/data/root/annotations/instances_val2017_revised_filtered_images.json',
        backend_args=None,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/path/to/data/root/annotations/instances_train2017_revised_filtered_images.json',
        backend_args=None,
