...
from ..layers import (DeformableDetrTransformerDecoder,
                      DeformableDetrTransformerDecoder_OnlyContrastive,
...
class DeformableDETR_OnlyContrastive(DetectionTransformer):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = DeformableDetrTransformerDecoder_OnlyContrastive(**self.decoder)
    ...
    def forward(self,
        ...
        if mode == 'loss':
            ...
            # loss를 수정하면서 else 부분과 같은 상황이 발생
                ...
                embedding_folder_path = '/path/to/repository/text_embedding_maker_modality/instances_val2017_revised'
            # embedding_folder_path = '/path/to/repository/text_embedding_maker_modality/instances_train2017_revised'
