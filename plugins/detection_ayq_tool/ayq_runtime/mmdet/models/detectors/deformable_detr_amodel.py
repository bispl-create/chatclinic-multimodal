...
class DeformableDETR_AMODEL(DetectionTransformer):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = DeformableDetrTransformerDecoder_AMODEL(**self.decoder)
        self.embed_dims = self.encoder.embed_dims
        if not self.as_two_stage:
            self.query_embedding = nn.Embedding(self.num_queries, #+ 1,
                                                self.embed_dims * 2)
