# Based on EVA, BEIT, timm, DeiT and BLIP2 code bases
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        img_size = (20, img_size, img_size)
        print('img_size', img_size, 'patch_size', patch_size)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        if use_abs_pos_emb:
            self.pos_embed_3d = nn.Parameter(torch.zeros(1, num_patches + 1, embed_dim))
        else:
...
def create_eva_vit_g_for_medblip(img_size=256,patch_size=28,drop_path_rate=0.4,use_checkpoint=False,precision="fp16"):
