...
@registry.register_model("vllama_stage1")
class vllamastage1(Blip2Base):
    """
    ...
    def __init__(
        ...
        self.perc_proj_chz = nn.Linear(512, self.llama_model.config.hidden_size).to(self.llama_model_device)
