...
class vllamaItaZformer(Blip2Base):
    ...
    def forward(self, samples):
        ...
        print('to_regress_tokens.attention_mask', to_regress_tokens.attention_mask)
        attention_mask = torch.cat([atts_bos, atts_img, to_regress_tokens.attention_mask], dim=1)
        ###Currently, empty-targets are all -100 -> we only predict the targets (the report or the answer for vqa task)
